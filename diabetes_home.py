...
def app(diabetes_df):
    ...
    st.markdown("""
    <p style='color:red;fontsize=25px' Diabetes is a chronic (long-lasting) health condition that affects how your body turns food into energy.
    ...
    beta_col1, beta_col2, beta_col3 = st.beta_colums(3)
    with beta_col1:
    ...
    with beta_col3:
      if st.checkbox('View column data'):
        column_data = st.selectbox(tuple(diabetes_df.columns))
